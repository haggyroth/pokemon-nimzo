"""Regression tests for tournament/season cancel handling (issue #130).
...
'completed' at the end of their loop.
...
from nidozo.api.models import PlayerSpec, StartSeasonRequest, StartTournamentRequest
from nidozo.api.orchestration import run_season, run_tournament
